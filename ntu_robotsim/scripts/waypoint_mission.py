...
def main():
    ...
    # Set initial pose
    navigator.setInitialPose(create_pose(-3.02, -2.99, 0.0))
    ...
    waypoints = [
        create_pose(3.5, 3.0, 0),     # Waypoint 1
        create_pose(3.7, -3.5, 0.0),    # Waypoint 2
        create_pose(-3.5, 0.0, 0.0),     # Waypoint 3
        create_pose(0.6, -3.5, 0.0),    # Waypoint 4
    ]
